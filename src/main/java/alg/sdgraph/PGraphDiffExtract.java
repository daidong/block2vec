 ...
 */
public class PGraphDiffExtract {
	...
	public PGraphDiffExtract(String path, String verify, String out){
		this.trainFile = path;
	...
	public void loadTrainFile() throws IOException, InterruptedException {
		...
		while ((line = br.readLine()) != null) {
			...
			for (int i = 0; i < blocks; i++) {
				sentenceSB.append(((diskId + i) * 10 + op )+ " ");
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		PGraphDiffExtract pg = new PGraphDiffExtract(args[0], args[1], args[2]);
		pg.loadTrainFile();
