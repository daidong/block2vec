 ...
 */
public class Block2VecNoExtract {
	...
	final int cutting_window = 10 * 1000 * 1000 * 1; // 1s is not good
	...
	public Block2VecNoExtract(String in, String verify, String out) {
		this.trainFile = in;
	...
	*/
	...
	public void predictAccuracyNN(int number) throws IOException {
		...
		while ((line = br.readLine()) != null) {
			...
			for (int a = 0; a < look_size; a++) {
				for (c = 0; c < layer1_size; c++) {
					neu1[c] += syn0[(c + lookbacks[a] * layer1_size)];
				}
				cw++;
			}
	...
	public void train() throws IOException, InterruptedException {
		...
		trainModel();
		outputTrainedBin();
		//predictAccuracyNN(20);
		predictAccuracyVV(20);
		predictAccuracyVV(40);
		predictAccuracyVV(60);
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		Block2VecNoExtract instance = new Block2VecNoExtract(args[0], args[1], args[2]);
		instance.train();
	}
}